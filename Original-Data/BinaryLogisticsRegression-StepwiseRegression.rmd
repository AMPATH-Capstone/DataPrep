                                          ...
                                          ifelse(ampath_data$highest_school_level_hsm1 == "Tertiary/Vocational", 3,
                                                  ifelse(ampath_data$highest_school_level_hsm1 == "University", 4, 
                                                         ifelse(ampath_data$highest_school_level_hsm1 == "Post-graduate", 5, 
                                                                 NA))))))
ampath_data$marital_status_hsm1<- ifelse(ampath_data$marital_status_hsm1 == "Married", 1, ifelse(ampath_data$marital_status_hsm1 == "Cohabitating", 2, ifelse(ampath_data$marital_status_hsm1 == "Divorced", 3,ifelse(ampath_data$marital_status_hsm1 == "Separated", 4, ifelse(ampath_data$marital_status_hsm1 == "Widowed", 5,ifelse(ampath_data$marital_status_hsm1 == "Separated", 4, ifelse(ampath_data$marital_status_hsm1 == "Never married", 6, NA)))))))

ampath_data$sex_hsm1 <- ifelse(ampath_data$sex_hsm1 == "Male", 1, ifelse(ampath_data$sex_hsm1 == "Female", 0, NA))
